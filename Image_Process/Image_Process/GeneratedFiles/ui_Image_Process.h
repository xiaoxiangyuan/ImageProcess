...
public:
    ...
    void setupUi(QMainWindow *Image_ProcessClass)
    {
        ...
        actHistm_2 = new QAction(Image_ProcessClass);
        actHistm_2->setObjectName(QStringLiteral("actHistm_2"));
        QIcon icon7;
        icon7.addFile(QStringLiteral("Resources/equalization.png"), QSize(), QIcon::Normal, QIcon::Off);
        actHistm_2->setIcon(icon7);
        ...
        mainToolBar->addAction(actHistm_2);
...
#endif // QT_NO_TOOLTIP
        actHistm_2->setText(QApplication::translate("Image_ProcessClass", "\345\235\207\350\241\241\345\214\226", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        actHistm_2->setToolTip(QApplication::translate("Image_ProcessClass", "\345\235\207\350\241\241\345\214\226", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
